...
public class QueueCommand {
    public static boolean queueCommand(SlashCommandInteractionEvent event) {
        ...
        try {
            ...
            PageList pageList = PageList.getInstance();
            pageList.clearPages();
            ...
            MessageWrapper.queueResponse(event, "🎵 Current queue 🎵 " + "Page: " + PageList.getInstance().getCurrentPage().getPageNumber() + "/" + PageList.getInstance().getTotalPages() + " Songs: " + PageList.getInstance().getTotalSongs(), String.valueOf(stringBuilder2));
            return true;
